...
::启动命令和参数
%runAppPath% worker --route-server-url http://route.oreminepool.top:8080/ --server-url public --worker-wallet-address Yg35XuZENFxEy3JcFa8rFhj2YfuyYK5fxbFeFSeWoRK
popd
